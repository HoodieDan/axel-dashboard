function Testiomonial() {
  return (
    <section className="py-[100px] px-[20px] lg:px-[60px] space-y-[84px] flex flex-col justify-center items-center">
      <div className="space-y-[24px] flex flex-col items-center">
        ...
        <div className="lg:w-[394px] text-wrap text-center mx-auto space-y-[15px] flex flex-col items-center">
          <h2 className="text-[30px] font-montreal lg:text-[40px] lg:w-[500px] leading-[42.1px] lg:leading-[56.2px]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-[30px]">
        <div className="lg:w-[420px] h-[474px] space-y-[41px] bg-[#C1C2B4] p-[24px] rounded-[20px]">
          <img src="./assets/nopic.svg" alt="" />
          <div className="space-y-[20px]">
            <p className="text-[20px]">
              "This platform revolutionized how I prepare for keynotes. The
              audience feedback feels incredibly real!"
            </p>
            <div className="flex gap-[8px] items-center">
              <img src="./assets/profile3.png" alt="profile" />
              <p className="text-[14px]">- Sarah M., Public Speaker</p>
            </div>
          </div>
        </div>
        <div className="lg:w-[420px] h-[474px] space-y-[41px] overflow-clip relative object-cover rounded-[20px]">
          <img
            src="./assets/testimonialimg.jpeg"
            alt=""
            className="h-full w-full object-cover absolute top-0 right-0"
          />
          <div className="h-full w-full top-0 right-0 bg-gradient-to-b from-0% to-black absolute" />
          <div className="space-y-[20px] absolute text-white px-[24px] bottom-[40px]">
            <p className="text-[20px]">
              “Practicing my pitch here gave me the confidence to win over
              investors. I highly recommend!”
            </p>

            <p className="text-[14px]">— John D., Startup Founder</p>
          </div>
        </div>
        <div className="lg:w-[420px] h-[474px] space-y-[41px] bg-[#EFF6FC] p-[24px] rounded-[20px]">
          <img src="./assets/nopic.svg" alt="" />
          <div className="space-y-[20px]">
            <p className="text-[20px]">
              "I love the detailed analytics and playback options. It's like
              having a personal speaking coach."
            </p>
            <div className="flex gap-[8px] items-center">
              <img src="./assets/profile1.png" alt="profile" />
              <p className="text-[14px]">- Priya S., Corporate Trainer</p>
            </div>
          </div>
        </div>
      </div>
