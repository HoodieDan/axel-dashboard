function Intro() {
  return (
    <section className="flex justify-center bg-alice-blue px-[20px] lg:px-[60px] py-[100px] lg:h-[952px] items-center">
      <div className="gap-y-[75px] relative rounded-[6.95px] flex w-full flex-col items-center bg-gradient-to-b from-[#E3E1E100] to-[#E3ECFF78]">
        <div className="space-y-[24px] flex flex-col items-center">
          <div className="px-[12px] py-[10px] flex gap-[10px] items-center w-max border rounded-[6px] bg-white border-[#E1E5E7] mx-auto">
            ...
            <p className="text-[14px]">INTRO</p>
          </div>

          <div className="lg:w-[704px] text-center mx-auto space-y-[15px] flex flex-col items-center">
            <h2 className="text-[30px] lg:text-[40px] lg:w-[606px] font-montreal leading-[42.15px] lg:leading-[56.2px]">
              Why Settle for Ordinary When You Can Practice Extraordinary
            </h2>
            <p className="text-dark-electric-blue text-[16px] lg:w-[614px] leading-[24px] ">
        ...
        <div className="flex flex-wrap items-center justify-center gap-[50px]">
          <div className="w-[290px] h-[300px] rounded-[15px] py-[20px] px-[25px] bg-gradient-to-b to-white from-alice-blue flex flex-col justify-center items-center text-center gap-y-[35px] ">
            <div className="p-[13.89px] rounded-[8px] bg-gunmetal w-max">
              <svg
                width="22"
                height="22"
                viewBox="0 0 22 22"
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g clip-path="url(#clip0_387_701)">
                  <path
                    d="M2.14508 13.3739C1.3284 10.3158 2.11965 6.91754 4.51884 4.51835C8.09865 0.938545 13.9027 0.938545 17.4825 4.51835C21.0623 8.09816 21.0623 13.9022 17.4825 17.482C15.0833 19.8812 11.685 20.6724 8.6269 19.8557M13.7508 13.7503V8.25026M13.7508 8.25026H8.25078M13.7508 8.25026L4.58394 17.4169"
                    stroke="white"
        ...
        <div className="relative h-[60px] w-full lg:w-max">
          <button className="flex gap-[8px] w-full lg:w-max h-[60px] px-[40px] relative mt-6 items-center justify-center rounded-full">
