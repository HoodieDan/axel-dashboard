    ...
    return (
       <div className='md:w-10/12 sm:w-3/5  sm:mx-auto flex  flex-col justify-center h-screen overflow-y-hidden gap-3 max-md:pl-0 max-lg:pl-5'>
             ...
             <div className='flex w-full sm:w-[75%] sm:mx-auto gap-4 font-[Montserrat] pt-2'>
                ...
                <p className='text-sm mx-auto font-[Montserrat] flex  items-center  mt-2 gap-1 text-[#475467]'>Didn't recieve any link? <button onClick={handleResendLink} className='font-semibold text-[#262B3A] bg-white p-0 m-0'>Click here</button></p>
       </div>
    );
};
