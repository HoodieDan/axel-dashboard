    ...
    const userLinks = [
        ...
        { 
            ...
            icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className='me-5' width="24" height="24" color="#BDBDBD" fill="none">
                        ...
                        <path d="M17.0002 7L16.1144 4.78543C15.7322 3.82996 15.3996 2.7461 14.4168 2.25955C13.8926 2 13.2618 2 12.0002 2C10.7386 2 10.1078 2 9.58354 2.25955C8.60079 2.7461 8.2682 3.82996 7.88601 4.78543L7.00018 7" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
    ...
    return (
        <nav className="side__nav py-7 px-5 relative">
            ...
            <div className="search__div w-full relative my-4">
                ...
                <input type="text" placeholder='Search' className='ps-8 py-2' />
            </div>
