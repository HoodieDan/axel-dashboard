...
import { setTopicQuestion, setContent, setSignupFlow } from "../../store/slices/authSlice";
...
const AuthQuestions: React.FC = () => {
 ...
 useEffect(() => {
  ...
  const handleInputContent = (e: React.ChangeEvent<HTMLInputElement>) => {
    const selectedContentId = e.target.value; // Get the selected contentId
  ...
  return (
    <div className="  md:flex flex-col max-lg:p-5 justify-center h-full">
          {welcomeMessage()}
    <div className="font-[Montserrat] mt-10 w-full md:mt-10">
